<template>
    <div class="minesweeper">
      <div class="minesweeper__status">
        <div class="minesweeper__bombcount">
          {{bombCount}}
        </div>
        <a href="#" @click.prevent="initGrid">
          &#9786;
        </a>
        <minesweeper-timer class="minesweeper__timer" :finished="finished"></minesweeper-timer>
      </div>
  
      <div class="minesweeper__grid" :style="getGridStyle()">
        <minesweeper-cell
